    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                <a href="<?php echo e(url('admin/module/page/create')); ?>" class="btn btn-primary"><?php echo e(__('Add new page')); ?></a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
               <form method="get" action="<?php echo e(url('/admin/module/page/')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                    <input  type="text" name="page" value="<?php echo e(Request()->page); ?>" placeholder="<?php echo e(__('Search by name')); ?>" class="form-control">
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="author"><?php echo e($row->getAuthor->name ?? ''); ?> </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Dungdt\booking-core\modules/Page/Views/admin/index.blade.php ENDPATH**/ ?>