        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <?php $typo = json_decode(setting_item('style_typo',"{}"),true) ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="style_typo[font_size]" class="form-control" min="0" max="60" value="<?php echo e($typo['font_size'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><?php echo e(__("Line Height")); ?></label>
                                    <input type="number" name="style_typo[line_height]" class="form-control" min="0" max="60" value="<?php echo e($typo['line_height'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__("Custom CSS")); ?></h3>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <div id="custom_css_editor" class="ace-editor" style="height: 400px" data-theme="monokai" data-mod="css"><?php echo e($settings['style_custom_css'] ?? ''); ?></div>
                        <textarea class=" d-none" name="style_custom_css" ><?php echo e($settings['style_custom_css'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?><?php /**PATH E:\Dungdt\booking-core\modules/Core/Views/admin/settings/groups/style.blade.php ENDPATH**/ ?>